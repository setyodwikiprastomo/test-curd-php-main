      ...
      <tbody class="table-group-divider">
        ...
        <tr>
          ...
          <td>
            ...
            <a type="button" class="btn btn-danger" href="proses-mahasiswa.php?hapus=<?php echo $result['npm'];?>" onClick="return confirm('apakah anda yakin ingin menghapus data tersebut??')"> <i class="bi bi-trash"></i> </a>
          </td>
        </tr>
        <?php
         }
      ...
      <?php
        ...
        <tr>
          ...
          <td>
            ...
            <a type="button" class="btn btn-danger" href="proses-matakuliah.php?hapus=<?php echo $result['kodemk'];?>" onClick="return confirm('apakah anda yakin ingin menghapus data tersebut??')"> <i class="bi bi-trash"></i> </a>
          </td>
        </tr>
       <?php
          }
      ...
      <?php
        ...
        <tr>
          ...
          <td>
            ...
            <a type="button" class="btn btn-danger" href="proses-krs.php?hapus=<?php echo $result['id'];?>" onClick="return confirm('apakah anda yakin ingin menghapus data tersebut??')"> <i class="bi bi-trash"></i> </a>
          </td>
        </tr>
        <?php
          }
